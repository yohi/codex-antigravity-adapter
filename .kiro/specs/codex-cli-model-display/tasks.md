...
- [ ] 3. プロキシルーターと依存性注入を統合
- [x] 3.1 プロキシアプリケーションにモデルカタログを注入するDI機構を実装
...
- [x] 3.2 `/v1/models` エンドポイントを更新し、注入されたモデルカタログを使用する
...
- [ ] 4. テストスイートの実装
- [x] 4.1 モデル設定読み込みサービスのユニットテストを作成
