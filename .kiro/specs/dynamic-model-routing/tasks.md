...
- [x] 3.6 ModelRoutingService の単体テストを作成する
...
- [x] 7. ドキュメントとサンプル設定の作成
- [x] 7.1 model-aliases.json のサンプルファイルを作成する
  - プロジェクトルートに model-aliases.json.example を作成する
  - fast、think、pro などの一般的なエイリアスを含める
  - コメント付きで使用方法を説明する
  - _Requirements: 1.1, 1.4_

- [x] 7.2 機能の使用方法を README に追加する
